...
const AddProductAdv = () => {
  ...
  return (
    <View className="product-screen-container">
      <FlatList
        data={[]}
        renderItem={null}
        ...
        ListHeaderComponent={
          <>
                ...
                <View className="product-score-col">
                  ...
                  <View className="product-nutri-bar">
                    {["A", "B", "C", "D", "E"].map((letter) => {
                      const isCurrent = nutriscore?.toUpperCase() === letter;
                      ...
                      return (
                        ...
                        >
                          <Text className="product-nutri-text">{letter}</Text>
                        </View>
                      );
                    })}
                  </View>
            ...
            {isDetailsExpanded && (
              <View className="product-card">
                <Text className="product-card-title">Wartości odżywcze</Text>
                ...
                {allergens && allergens.length > 0 && (
                  <View className="mt-3">
                    <Text className="product-detail-label mb-1">Alergeny</Text>
                ...
                <View className="mt-4 pt-2 border-t border-gray-100">
                  ...
                  <View className="product-detail-row">
                    <Text className="product-detail-label">Kraj sprzedaży</Text>
